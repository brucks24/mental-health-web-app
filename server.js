...
app.post('/register', checkNotAuthenticated, async (req, res) => {
    ...
    if(!isconnected) {
        res.redirect('regiser.ejs', {message: "Could not connect to database please try again"})
    } else {
        //con.query
        var sql = "INSERT into Profile(firstName, lastName, email, password, phoneNumber, type)" +
                "VALUES(?,?,?,?,?,?)"
        con.query(sql, 
